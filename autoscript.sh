...
read -p "Installing bind9, dnsutils, apache2, vsftpd, openssh-server, dovecot-core, dovecot-imapd, samba, dhcp server, ip calc and squid proxy (y/n) : " tools
if [[ $tools == "y" ]]
  then
	apt install bind9 dnsutils apache2 vsftpd openssh-server dovecot-core dovecot-imapd samba squid isc-dhcp-server ipcalc
	printf "\e[1;32m\n[Done!!!]\e[0m\n"
elif [[ $tools == "n" ]]
  then
...
printf "\e[1;38m[+] MAIL SERVER (dovecot-core & dovecot-imapd)\e[0m            [\e[1;31mComing soon\e[0m]\n"
...
printf "\n\n"
printf "\e[1;31mPROFTPD CONFIGURATION\e[0m\n"
read -p 'name directory for ftp (ex: rxz)    : ' ftpdir
mkdir /home/$ftpdir
#printf "\e[1;32m[+]============================================================[+]\e[0m\n"
printf "\n\n"
...
echo "$blockweb" > /etc/squid/tolak
read -p 'the name of domain you gonna allow  : ' allowweb
echo "$alloweb" > /etc/squid/terima
...
acl terima dstdomain "/etc/squid/terima"
